class TenantFamilyMembersController < ApplicationController
  ...
  def index
    @tenant_family_members = TenantFamilyMember.all
  end
  ...
  def create
    ...
    respond_to do |format|
      if @tenant_family_member.save
        format.html { redirect_to @tenant_family_member, notice: 'Tenant family member was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tenant_family_members_url, notice: 'Tenant family member was successfully destroyed.' }
